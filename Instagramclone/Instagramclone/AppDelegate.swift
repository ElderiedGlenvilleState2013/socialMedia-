...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let parseConfiguration = ParseClientConfiguration(block: { (ParseMutableClientConfiguration) -> Void in
            ParseMutableClientConfiguration.applicationId = "5cbab221050101d329f6f7e907d26dd7e2bfed4c"
            ParseMutableClientConfiguration.clientKey = "e330335e24bc0e7c48e6fbbbd89cdede35ee53ca"
            ParseMutableClientConfiguration.server = "http://3.17.73.6:80/parse"
        })
